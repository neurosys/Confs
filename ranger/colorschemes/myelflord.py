...
# 15 White
# 16 Black
# 17 - 21 Various shades of blue, from darkest to lightest
# 22 Dark Green

class MyElflord(ColorScheme):
    ...
    def use(self, context):  # pylint: disable=too-many-branches,too-many-statements
        ...
        if context.reset:
            ...
            # DEXOLD fg = 244
            # The normal files that are found in the directory
            fg = white
            if context.selected:
                attr = reverse
            else:
            ...
            if context.hostname:
                ...
                # DEXOLD fg = 33
                # This is the path displayed on top of the window
                fg = cyan
            elif context.tab:
                # DEXOLD fg = 47 if context.good else 33
                # DEXOLD bg = 239
                fg = magenta if context.good else cyan
                bg = 239 # Some kind of grey
            elif context.link:
                fg = cyan
