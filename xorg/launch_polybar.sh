...
then
    polybar -c ~/.myconfig/xorg/polybar_work_desktop.conf mon1 &
    polybar -c ~/.myconfig/xorg/polybar_work_desktop.conf mon2 &
    polybar -c ~/.myconfig/xorg/polybar_work_desktop.conf mon3 &
fi
